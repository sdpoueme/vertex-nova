...
| Appareils | Per-device forms: security level, normal hours, AI context, notification sources (Alexa API / email / webhook). Alexa device discovery. Activity charts. Vocal alerts toggle. |
